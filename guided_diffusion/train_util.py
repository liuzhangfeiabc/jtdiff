...
class TrainLoop():
    ...
    def __init__(self, *, model, diffusion, data, batch_size, microbatch, lr, ema_rate, log_interval, save_interval, resume_checkpoint, use_fp16=False, fp16_scale_growth=0.001, schedule_sampler=None, weight_decay=0.0, lr_anneal_steps=0):
        ...
        self.sync_cuda = jt.cuda.is_available()
    ...
    def _load_and_sync_parameters(self):
        ...
        if resume_checkpoint:
            ...
            if (dist.get_rank() == 0):
                ...
                self.model.load_parameters(dist_util.load_parameters(resume_checkpoint, map_location=dist_util.dev()))
    ...
    def _load_ema_parameters(self, rate):
        ...
        if ema_checkpoint:
            if (dist.get_rank() == 0):
                ...
                state_dict = dist_util.load_parameters(ema_checkpoint, map_location=dist_util.dev())
    ...
    def _load_optimizer_state(self):
        ...
        if bf.exists(opt_checkpoint):
            ...
            state_dict = dist_util.load_parameters(opt_checkpoint, map_location=dist_util.dev())
            self.opt.load_parameters(state_dict)
